...
DYNAMIC_CELL_INFO = {
    "Malignant (early pre-B)": {
        "base_info": {
            "normal_range": "1-4% of total WBC",
            "primary_function": "Allergic reactions and parasitic defense",
            "key_features": ["Bi-lobed nucleus", "Pink/orange granules", "Moderate size"]
        },
        "dynamic_suggestions": [
            {
                "condition": "elevated_confidence",
                "insights": [
                    "Clear bi-lobed nucleus structure detected",
                    "Characteristic eosinophilic granules are prominent",
                    "Cell morphology suggests active allergic response",
                    "Consider recent allergen exposure history"
                ]
            },
            {
                "condition": "moderate_confidence", 
                "insights": [
                    "Granular pattern partially visible",
                    "Nuclear lobulation needs confirmation",
                    "May require additional staining for clarity",
                    "Consider correlation with patient symptoms"
                ]
            },
            {
                "condition": "low_confidence",
                "insights": [
                    "Cell boundaries require better definition",
                    "Nuclear structure unclear in current image",
                    "Recommend higher magnification imaging",
                    "Consider manual differential count verification"
                ]
            }
        ]
    },
    "Malignant (pre-B)": {
        "base_info": {
            "normal_range": "20-40% of total WBC",
            "primary_function": "Adaptive immunity and antibody production",
            "key_features": ["Large round nucleus", "Minimal cytoplasm", "High N:C ratio"]
        },
        "dynamic_suggestions": [
            {
                "condition": "elevated_confidence",
                "insights": [
                    "Characteristic high nucleus-to-cytoplasm ratio observed",
                    "Dense chromatin pattern typical of mature lymphocyte",
                    "Cell size suggests small lymphocyte population",
                    "Consider viral infection if counts are elevated"
                ]
            },
            {
                "condition": "moderate_confidence",
                "insights": [
                    "Nuclear chromatin pattern partially visible",
                    "Cytoplasm boundaries need clearer definition",
                    "Size classification requires confirmation",
                    "May represent reactive lymphocyte variant"
                ]
            },
            {
                "condition": "low_confidence",
                "insights": [
                    "Cell morphology overlaps with other mononuclear cells",
                    "Nuclear details insufficient for definitive classification",
                    "Consider immunophenotyping for accurate identification",
                    "Recommend expert morphologist review"
                ]
            }
        ]
    },
    "Malignant (pro-B)": {
        "base_info": {
            "normal_range": "2-8% of total WBC",
            "primary_function": "Phagocytosis and antigen presentation",
            "key_features": ["Kidney-shaped nucleus", "Abundant cytoplasm", "Largest WBC"]
        },
        "dynamic_suggestions": [
            {
                "condition": "elevated_confidence",
                "insights": [
                    "Characteristic kidney-shaped nucleus clearly visible",
                    "Abundant gray-blue cytoplasm confirms monocyte identity",
                    "Cell size consistent with mature monocyte",
                    "May indicate ongoing inflammatory response"
                ]
            },
            {
                "condition": "moderate_confidence",
                "insights": [
                    "Nuclear indentation partially visible",
                    "Cytoplasm volume suggests mononuclear cell",
                    "Vacuolation pattern needs evaluation",
                    "Consider activated monocyte variant"
                ]
            },
            {
                "condition": "low_confidence",
                "insights": [
                    "Nuclear morphology requires better resolution",
                    "Cytoplasm boundaries unclear",
                    "May represent immature monocytic cell",
                    "Consider flow cytometry for confirmation"
                ]
            }
        ]
    },
    "Benign": {
        "base_info": {
            ...
            "primary_function": "Bacterial defense and acute inflammation",
            "key_features": ["Multi-lobed nucleus", "Fine granules", "Most abundant WBC"]
        },
        "dynamic_suggestions": [
            {
                "condition": "elevated_confidence",
                "insights": [
                    "Multi-lobed nucleus with 3-5 segments clearly visible",
                    "Fine neutrophilic granules distributed throughout cytoplasm",
                    "Nuclear hypersegmentation may indicate B12/folate deficiency",
                    "Consider left shift if bands are present"
                ]
            },
            {
                "condition": "moderate_confidence",
                "insights": [
                    "Nuclear lobulation partially obscured",
                    "Granule pattern suggests neutrophilic lineage",
                    "Cell maturation stage requires confirmation",
                    "May represent metamyelocyte or band form"
                ]
            },
            {
                "condition": "low_confidence",
                "insights": [
                    "Nuclear segmentation difficult to assess",
                    "Granulation pattern unclear",
                    "Consider immature granulocyte possibility",
                    "Recommend manual differential for accuracy"
                ]
            }
        ]
    }
